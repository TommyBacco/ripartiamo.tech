...
if($_SESSION['pagina'] != "pagina10.php"){
...
if (isset($_SESSION['email']) && isset($_POST["soddisfazione"])) {
...
$mail = $_SESSION['email'];
 ...
 $sql = "UPDATE tblsurvey SET  Soddisfazione = '".$_POST['soddisfazione']."' WHERE Mail = '$mail'";
if(! mysqli_query($conn, $sql))
  echo (mysqli_errno($conn).":". mysqli_error($conn));  
mysqli_close($conn);
$_SESSION['pagina'] = "pagina11.php";
...
<body>
  ...
  <form action = "" method = "post" >
    <div class="form-group" >
      <h2 id="label" >Quanto sei soddisfatto da 1 a 5 del supporto ricevuto da governo ed enti pubblici?</h2>
 ...
 <div id = "divRadio">
     <div class="list-group" >
        <div class="btn-group btn-group-toggle" data-toggle="buttons" >
         ...
         <input type="hidden" id="Rete" name="soddisfazione" value="">
